...
class EventDetector:
    ...
    def __init__(
        ...
        # Antes de carregar YOLO, aplicar fallback para torchvision.ops.nms se necessario
        try:
            # Comentarios sem acentos: tentar executar nms para detectar operador ausente
            import torch
            import torchvision
            ...
            # Se torchvision nao estiver disponivel, seguir adiante (ultralytics pode usar nms proprio)
            pass
